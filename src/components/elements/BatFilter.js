...
import BatGridView from "@/components/elements/BatItem"
import projectData from "@/lib/bat.json"
export default function BatFilter({ col }) {
                    ...
                    <div className="project-item-wrap">
                        <div className="row">
                            {getPaginatedProducts.map((item, i) => (
                                <BatGridView item={item} col={col} key={i} />
                            ))}
                        </div>
                    </div>
                   {/*<Pagination
