...
export default function Header7({ handleMobileMenu, scroll }: any) {
                ...
                <div className="header-top-right">
                  <ul className="list-wrap">
                   <li><Link href="mailto:contact@sedec.ma">contact@sedec.ma</Link></li>
                                        <li><Link href="0537741119">+ 212 (0) 537 741 119</Link></li>
                  </ul>
                </div>
              </div>
            </div>
  ...
  {/* Submenu */}
  <ul
    className="sub-menu absolute left-0 top-full mt-2 hidden w-[700px] bg-white shadow-lg rounded-lg p-6 group-hover:flex flex-wrap gap-6 z-50"
  >
    ...
    <li className=" flex items-center text-center">
      <Link href="/">
        ...
        />
        <span className="font-semibold text-gray-800 hover:text-amber-800">Scandinavian</span>
      </Link>
    </li>
    ...
    <li className=" flex flex-col items-center text-center">
      <Link href="/index-7">
        <img
          ...
          className="w-full h-auto object-cover rounded-lg mb-3 transition-transform duration-300 hover:scale-105"
        />
        <span className="font-semibold text-gray-800 hover:text-amber-800">Toubkal</span>
      </Link>
    </li>
    ...
    <li className=" flex flex-col items-center text-center">
      <Link href="/index-8">
        <img
          ...
          className="w-full h-auto object-cover rounded-lg mb-3 transition-transform duration-300 hover:scale-105"
        />
        <span className="font-semibold text-gray-800 hover:text-amber-800">M&M</span>
      </Link>
    </li>
    ...
    <li className="flex flex-col items-center text-center">
      <Link href="/index-9">
        <img
          ...
          className="w-full h-auto object-cover rounded-lg mb-3 transition-transform duration-300 hover:scale-105"
        />
        <span className="font-semibold text-gray-800 hover:text-amber-800">Moroccan Touch</span>
      </Link>
    </li>
    </div>
  </ul>
