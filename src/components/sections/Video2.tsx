    ...
    <>
          ...
          <div className="row">
            ...
            <div className="col-12">
              ...
              <div className="video-bg"> 
                ...
                <img src="/optimized/logoMM.webp" alt=""  className="lg:w-24 w-16 h-auto "/>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <div className="relative">
            <img src="/optimized/logoM.webp" alt="Logo" className="lg:w-20 w-16 h-auto absolute bottom-26 left-6 z-50" />
            <iframe
            src={mpUrl}
            allowFullScreen
